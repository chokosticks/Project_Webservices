 ...
 */
public class ClosestWordsOptimal {
    ...
    public ClosestWordsOptimal(ArrayList<String> wordList){
    ...
    int partDist(String word, String comparingWord, int[] currentRow, int[] previousRow) {
        ...
        int cost;
        //int[] currentRow = new int[comparingWord.length() + 1];
        //int[] previousRow = new int[comparingWord.length() + 1];
    ...
    public void calculateDistance(String word){
        ...
        for(String comparingWord: wordList){
            ...
            if(Math.abs(wordLength-compWordLength)/*compWordLength-wordLength*/ > closestDistance || compareUniqueLetters(wordUniqueLetters, comparingWord) > closestDistance) continue;

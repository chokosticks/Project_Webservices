...
public class Main {
  ...
  public static void main(String args[]) throws IOException {
      ...
      ClosestWordsOptimal closestWordsOptimal = new ClosestWordsOptimal(wordList1);

      while ((word = stdin.readLine()) != null) {

          //calculate the distance from the given word and the wordlist.
          closestWordsOptimal.calculateDistance(word);
          sb1.append(word).append(" (").append(closestWordsOptimal.getMinDistance()).append(")");

         for (String w : closestWordsOptimal.getClosestWords())
             sb1.append(" ").append(w);
